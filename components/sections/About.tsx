  ...
  return (
    <section className="mx-4 xl:mx-20 lg:mx-20 xl:h-screen lg:h-screen flex items-center mix-blend-difference z-10">
      <div className="flex flex-col xl:flex-row lg:flex-row items-center justify-center">
        ...
        <div className="xl:w-1/2 lg:w-1/2 flex items-center justify-end mt-4 lg:mt-0">
          <div
            ref={ref}
            className={cn(
              "invisible h-96 w-96 lg:w-5/6 relative overflow-hidden",
              {
                "reveal-delay": reveal,
              }
            )}
          >
            <Image
              ...
              layout="fill"
              placeholder="blur"
              className="object-cover object-center opacity-80 backdrop-grayscale hover:backdrop-grayscale-0"
            />
          </div>
        </div>
      </div>
