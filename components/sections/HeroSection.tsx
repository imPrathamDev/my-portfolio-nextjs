...
const HeroSection = () => {
  ...
  return (
    <section
      ref={section}
      className="relative lg:flex lg:flex-col lg:items-center lg:justify-center text-center h-[84vh] xl:h-screen lg:h-screen mix-blend-difference mb-28 lg:mb-0 overflow-hidden"
    >
      <div className="xl:absolute lg:absolute xl:top-6 lg:top-6 flex flex-col items-center justify-center gap-y-4">
        ...
        <div
          id="hero-marquee"
          className="absolute right-4 bottom-[10vh] lg:bottom-[30vh] lg:-right-[6vw] py-1 rounded-full border border-primary-dark-white/20 max-w-[50vw] lg:max-w-[25vw] bg-primary-black/10 backdrop-blur-lg z-[999999999] linkHover opacity-0 transform translate-x-52"
        >
        ...
        <h2
          id="heading"
          className="font-dream-avenue text-[4rem] leading-[1] lg:text-[25vh] lg:leading-none"
        >
          Design & Development Portfolio
        </h2>
        <div id="text-container" className="max-w-3xl z-10">
          <p className="text-primary-dark-white text-sm lg:text-base my-2 px-4">
            Pratham Sharma is a skilled Web and Mobile Application Developer
            with expertise in modern technologies. His portfolio showcases a
            range of innovative projects and insightful blog posts. Specializing
            in website development using MERN stack and Next.js, as well as
            mobile application development with React Native, Pratham
            consistently seeks out challenging and fascinating project ideas.
            Explore his portfolio to discover his technical proficiency and
