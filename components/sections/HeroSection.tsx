...
const HeroSection = () => {
  ...
  return (
    <section
      ...
      className="relative lg:flex lg:flex-col lg:items-center lg:justify-center text-center h-[84vh] xl:h-screen lg:h-screen mix-blend-difference mb-28 lg:mb-0"
    >
      <div className="xl:absolute lg:absolute xl:top-6 lg:top-6 flex flex-col items-center justify-center gap-y-4">
        ...
        <div className="max-w-2xl">
          <p
            data-scroll
            className="text-primary-dark-white text-sm lg:text-base my-2 px-4"
          >
      ...
      <div
        ...
        data-scroll-speed="2"
        className="xl:block lg:block img-animate absolute lg:left-0 bottom-0"
      >
        <div
          data-scroll
          id="img-container"
